				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li class="current-menu-item"><a href="gallery.html">Gallery<span class="subheader">Featured work</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<!-- title -->
						<div id="page-title">
							<span class="title">The Gallery</span>
							<span class="subtitle">Three columns layout gallery</span>
						</div>
						<!-- ENDS title -->
						...
						<ul id="portfolio-list" class="gallery three-cols">
							<li class="pink"><a href="img/dummies/282x267.gif" rel="group1" class="fancybox" title="Lorem ipsum dolor"><img src="img/dummies/282x267.gif" alt="Pic"></a></li>
							<li class="pink "><a href="img/dummies/282x267.gif" rel="group1" class="fancybox" title="Lorem ipsum dolor"><img src="img/dummies/282x267.gif" alt="Pic"></a></li>
							<li class="pink"><a href="img/dummies/282x267.gif" rel="group1" class="fancybox" title="Lorem ipsum dolor"><img src="img/dummies/282x267.gif" alt="Pic"></a></li>
							<li class="blue"><a href="img/dummies/282x267.gif" rel="group1" class="fancybox" title="Lorem ipsum dolor"><img src="img/dummies/282x267.gif" alt="Pic"></a></li>
							<li class="blue"><a href="img/dummies/282x267.gif" rel="group1" class="fancybox" title="Lorem ipsum dolor"><img src="img/dummies/282x267.gif" alt="Pic"></a></li>
							<li class="green"><a href="img/dummies/282x267.gif" rel="group1" class="fancybox" title="Lorem ipsum dolor"><img src="img/dummies/282x267.gif" alt="Pic"></a></li>
						</ul>
						<!-- ENDS gallery -->	
