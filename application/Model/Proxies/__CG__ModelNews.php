 ...
 */
class News extends \Model\News implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'title', 'summary', 'contain', 'fount', 'imagename', 'newsdate', 'categoryId', 'category', 'administratorId', 'administrator', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
    ...
    public function getFount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFount', array());

        return parent::getFount();
    }
    ...
    public function setFount($fount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFount', array($fount));

        return parent::setFount($fount);
    }
