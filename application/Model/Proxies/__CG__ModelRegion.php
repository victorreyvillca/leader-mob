 ...
 */
class Region extends \Model\Region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'abreviation', 'description', 'missionId', 'mission', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
