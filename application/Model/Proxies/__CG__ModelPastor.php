 ...
 */
class Pastor extends \Model\Pastor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'dateChristening', 'address', 'note', 'email', 'yearService', 'isActivo', 'departmentId', 'department', 'districtId', 'district', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pastor $proxy) {
