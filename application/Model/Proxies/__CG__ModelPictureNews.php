 ...
 */
class PictureNews extends \Model\PictureNews implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'newsId', 'news', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PictureNews $proxy) {
