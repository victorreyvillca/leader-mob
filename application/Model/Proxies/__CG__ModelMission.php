 ...
 */
class Mission extends \Model\Mission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'abreviation', 'description', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
