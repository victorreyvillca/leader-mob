 ...
 */
class ClassConqueror extends \Model\ClassConqueror implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'description', 'classType', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassConqueror $proxy) {
    ...
    public function setClassType($classType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClassType', array($classType));
