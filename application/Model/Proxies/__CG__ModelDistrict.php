 ...
 */
class District extends \Model\District implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'description', 'regionId', 'region', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
