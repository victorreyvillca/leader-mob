...
class PositionController extends Dis_Controller_Action {
...
// 			}
	...
	public function editAction() {
		...
		$category = $this->_entityManager->find('Model\Position', $id);
...
// 				}
	...
	public function readItemsAction() {
		...
		$categoryRepo = $this->_entityManager->getRepository('Model\Position');
